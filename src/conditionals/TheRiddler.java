...
String monopoly=JOptionPane.showInputDialog("A man is pushing his car along the road when he comes to a hotel. He shouts, 'I'm bankrupt!' Why (one word answer)?" );
...
String Imagine=JOptionPane.showInputDialog("Imagine you are in a dark room. How do you get out (two word answer)?" );
